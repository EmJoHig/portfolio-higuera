...
// import { Announcement, AnnouncementTitle ,AnnouncementTag} from '@/src/components/ui/announcement';
...
//                 Tecnología con propósito, diseño con visión.
//               </p>
...
export function HeroSection() {
  ...
  return (
    <motion.section
      ...
      className="w-full min-h-screen flex items-center justify-center relative overflow-hidden z-10"
    >
      {/* Background Image con transparencia dinámica */}
      <div
        className="
    absolute inset-0 w-full h-full pointer-events-none select-none
    [mask-image:linear-gradient(to_bottom,black_70%,transparent_100%)]
    dark:[mask-image:linear-gradient(to_bottom,black_65%,transparent_100%)]
  "
      >
        <Image
          src="/img/fondo3.jpg"
          alt="Fondo Circuitos"
          fill
          className={`object-cover transition-all duration-500 ${imageClass}`}
        />
      </div>
