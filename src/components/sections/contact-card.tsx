  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto">
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <Card>
          <CardHeader>
            <CardTitle className="text-2xl sm:text-3xl text-primary/80 dark:text-cyan-300/80 ">Contact</CardTitle>
            {/* <p className="mt-1 text-sm text-muted-foreground text-primary/80 dark:text-cyan-300/80 ">Cuéntame sobre tu proyecto o haz una pregunta </p> */}
          </CardHeader>
