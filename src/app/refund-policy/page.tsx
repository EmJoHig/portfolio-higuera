...
import { siteConfig, buildMetadata } from "@/src/config/site.config";
  ...
  <main className="max-w-5xl mx-auto pt-20 sm:pt-24 pb-12 px-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="mb-4">This Refund Policy applies to purchases and services made through EmanuelHiguera (BelthierDev) and to any related offerings or services provided by Emanuel Higuera personally or by BelthierDev. References to &quot;we&quot;, &quot;us&quot;, or &quot;our&quot; include both Emanuel Higuera and BelthierDev where applicable.</p>
          ...
          <p className="mb-2 text-sm">This Policy covers paid services, deposits, and fees charged for project work, consulting, and digital goods sold directly by Emanuel Higuera</p>
          ...
          <p className="mb-2 text-sm">To request a refund, please do the following:
            <ol className="list-decimal list-inside ml-5 mt-2">
              <li>Identify where you purchased the service (EmanuelHiguera) and include an invoice/order number or proof of
                payment.</li>
              <li>Email <a className="underline text-primary" href="mailto:emanuel.higuera@hotmail.com">refund@emanuel.higuera@hotmail.com</a> 
               (for purchases on
                EmanuelHiguera) with your request and supporting documentation.
              </li>
          ...
          <p className="mb-2 text-sm">For refund requests or questions: <a className="underline text-primary" href="mailto:emanuel.higuera@hotmail.com">emanuel.higuera@hotmail.com</a> (for purchases made via emanuel.higuera@hotmail.com), <a className="underline text-primary" href="mailto:emanuel.higuera@hotmail.com">emanuel.higuera@hotmail.com</a> (personal).</p>
